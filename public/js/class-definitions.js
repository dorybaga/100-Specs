...
var polygon = new Shape(2).getType();
 ...
 *
 */
var openAClosedBox = new Box("pencils", false).openBox();
var closeAnOpenBox = new Box("donuts", true).openBox();
 ...
 *
 */
var farTooTallAStory = new House(50).isATallStory(20);
var shortStory = new House(3).isATallStory(5);
...
var cookieMonsterBlocked = new Cookie("oatmeal").swipedByCookieMonster("Sunday");
 ...
 *
 */
var badForYou = new Meal(["chips", "soda"]).containsJunkFood();
var goodForYou = new Meal(["fish", "poi"]).containsJunkFood();
